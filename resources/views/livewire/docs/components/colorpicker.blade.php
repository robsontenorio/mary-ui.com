...
<div class="docs">
    ...
    <x-code class="grid gap-10">
        @verbatim('docs')
            <x-colorpicker wire:model="color2" label="Select a color" hint="A nice color" />

            <x-colorpicker wire:model="color1" icon="o-swatch" />

            <x-colorpicker wire:model="color3" label="Color" placeholder="Select a color" inline />
        @endverbatim
    </x-code>
</div>
